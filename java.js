...
function updateHeaderLogoSmart() {
  ...
  if (lum < 150) {
    logo5.src = "Vectori/logo-alb.svg";
    meniuul.style.color="white";
    cerculethead2.style.borderColor="white";
  } else {
    logo5.src = "Vectori/logo-negru.svg";
    meniuul.style.color="black";
    cerculethead2.style.borderColor="black";
  }
}
...
// Să actualizeze și la resize (în caz că se schimbă layout-ul)
window.addEventListener('resize', () => {
  if (headerVisible) updateHeaderLogoSmart();
});
